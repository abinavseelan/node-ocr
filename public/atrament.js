var Atrament = (function (t) {
    ...
    t.exports = (function (t) {
      function e(t) {
        ...
        if (
          ((r = this),
          (i = a(e).call(this)),
          (n = !i || ("object" !== o(i) && "function" != typeof i) ? s(r) : i),
          t instanceof window.Node && "CANVAS" === t.tagName)
        )
          n.canvas = t;
        else {
          if ("string" != typeof t)
            throw new Error("can't look for canvas based on '".concat(t, "'"));
          n.canvas = document.querySelector(t);
        }
        if (!n.canvas) throw new Error("canvas not found");
        (n.canvas.width = c.width || n.canvas.width),
          (n.canvas.height = c.height || n.canvas.height),
          (n.mouse = new h());
        var u = function (t) {
            ...
            var e = n.canvas.getBoundingClientRect(),
              ...
              r = o.offsetX,
              i = o.offsetY;
            void 0 === r && (r = o.clientX - e.left),
              void 0 === i && (i = o.clientY - e.top);
            var a = s(n).mouse;
          ...
          l = function (t) {
            if ((t.cancelable && t.preventDefault(), u(t), n.mode !== d.FILL)) {
              var e = s(n).mouse;
              e.previous.set(e.x, e.y),
                (e.down = !0),
                n.beginStroke(e.previous.x, e.previous.y);
            } else n.fill();
          },
          p = function (t) {
            if (n.mode !== d.FILL) {
              var e = s(n).mouse,
                ...
                i = o.offsetY;
              if (
                ((e.down = !1), e.x === r && e.y === i && y.includes(n.mode))
              ) {
        ...
        return (
          ...
          (n._mode = d.DRAW),
          (n.adaptiveStroke = !0),
          ["weight", "smoothing", "adaptiveStroke", "mode"].forEach(function (
            t
          ) {
        ...
        (u = [
          ...
          },
          {
            ...
            value: function (t, e, n, o) {
              ...
              var r = this.context,
                ...
                a = Math.min(
                  f.minSmoothingFactor,
                  this.smoothing + (i - 60) / 3e3
                ),
                s = t - (t - n) * a,
                c = e - (e - o) * a,
              ...
              return (
                this.adaptiveStroke
                  ? ((this._targetThickness =
                      ((u - f.minLineThickness) / f.lineThicknessRange) *
                        (this._maxWeight - this._weight) +
                      this._weight),
                    this._thickness > this._targetThickness
                      ? (this._thickness -= f.thicknessIncrement)
                      : this._thickness < this._targetThickness &&
                        (this._thickness += f.thicknessIncrement),
                    (r.lineWidth = this._thickness))
                  : (r.lineWidth = this._weight),
                r.quadraticCurveTo(n, o, s, c),
                r.stroke(),
                { x: s, y: c }
              );
            },
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (
                v.matchColor.apply(
                  v,
                  [l.data].concat([].concat(r(h), [255]))
                )(4 * (a * o.canvas.width + i))
              )
                return (
                  (this._filling = !1), void this.dispatchEvent("fillend", {})
                );
              for (; u.length; ) {
                for (
                  var y = u.pop(), m = y[0], g = y[1], b = 4 * (g * s + m);
                  g-- >= 0 && d(b);
              ...
              o.putImageData(l, 0, 0),
                this._fillStack.length
                  ? this._floodFill.apply(this, r(this._fillStack.shift()))
                  : ((this._filling = !1), this.dispatchEvent("fillend", {}));
            },
          },
          {
            key: "color",
          ...
          },
          {
            ...
            set: function (t) {
              ...
              (this._weight = t),
                (this._thickness = t),
                (this._targetThickness = t),
                (this._maxWeight = t + f.weightSpread);
            },
          },
          {
            key: "mode",
    ...
    var c = (function () {
      ...
      u = (function (t) {
        function e() {
          ...
          return (
            a(this, e),
            ((t = o(this, r(e).call(this, 0, 0))).down = !1),
            (t.previous = new c(0, 0)),
            t
          );
        }
        return (
  ...
  function (t, e) {
    ...
    (n.lineThicknessRange = n.maxLineThickness - n.minLineThickness),
      (n.thicknessIncrement = 0.5),
      (n.minSmoothingFactor = 0.87),
      (n.initialSmoothingFactor = 0.85),
      (n.weightSpread = 10),
      (n.initialThickness = 2),
      (t.exports = n);
  },
  function (t, e) {
    function n(t) {
  ...
  function (t, e) {
    ...
    (e.lineDistance = function (t, e, n, o) {
      ...
      (e.colorPixel = function (t, o, r, i, a, s) {
        var c,
          u = (c = e).matchColor.apply(c, [t].concat(n(a)));
        return function (e) {
          (t[e] = o),
            (t[e + 1] = r),
            (t[e + 2] = i),
            (t[e + 3] = s),
            u(e + 4) ||
              ((t[e + 4] = 0.01 * t[e + 4] + 0.99 * o),
              (t[e + 4 + 1] = 0.01 * t[e + 4 + 1] + 0.99 * r),
              (t[e + 4 + 2] = 0.01 * t[e + 4 + 2] + 0.99 * i),
              (t[e + 4 + 3] = 0.01 * t[e + 4 + 3] + 0.99 * s)),
            u(e - 4) ||
              ((t[e - 4] = 0.01 * t[e - 4] + 0.99 * o),
              (t[e - 4 + 1] = 0.01 * t[e - 4 + 1] + 0.99 * r),
              (t[e - 4 + 2] = 0.01 * t[e - 4 + 2] + 0.99 * i),
